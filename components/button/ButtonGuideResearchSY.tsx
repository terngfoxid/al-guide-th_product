...
export default function ButtonGuideResearchSY() {
  const card_style = {
    shape:
    ...
    image_src: "/images/ResearchSY 600x300.webp",
  };

  return (
    <button className={card_style.shape}>
      <Link href="/research_shipyard_guide" className="w-full">
        <Image
          src={card_style.image_src}
          className={card_style.image_style}
          alt="ไกด์เรือวิจัย azur lane , Research Shipyard"
          width="600"
          height="300"
        />
      </Link>
