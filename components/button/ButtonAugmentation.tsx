...
export default function ButtonAugmentation() {
  const card_style = {
    shape:
    ...
    image_src: "/images/Augmentation 600x300.webp",
  };

  return (
    <button className={card_style.shape}>
      <Link href="/augmentation" className="w-full">
        <Image
          src={card_style.image_src}
          className={card_style.image_style}
          alt="ข้อมูล augment azur lane , Augmentation"
          width="600"
          height="300"
        />
      </Link>
