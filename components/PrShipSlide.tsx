...
export const PrSlide: React.FC<{
  ...
  return (
    <div className="relative overflow-hidden rounded-lg shadow-xl bg-neutral-200 dark:bg-neutral-900">
      ...
      <div className="absolute left-0 right-0 text-center top-2">
      ...
      <button
        className="absolute top-0 bottom-0 left-0 hidden p-2 transition md:block text-zinc-600 dark:text-zinc-400 bg-neutral-200 dark:bg-neutral-900 bg-opacity-80 dark:bg-opacity-80 hover:bg-opacity-70 dark:hover:hover:bg-opacity-70"
        onClick={() =>
      ...
      <button
        className="absolute top-0 bottom-0 right-0 hidden p-2 transition md:block text-zinc-600 dark:text-zinc-400 bg-neutral-200 dark:bg-neutral-900 bg-opacity-80 dark:bg-opacity-80 hover:bg-opacity-70 dark:hover:hover:bg-opacity-70"
        onClick={() =>
          setSlideIndex((current) =>
