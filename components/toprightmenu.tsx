...
import PopupDialog, { IPopupRef } from "./popup";
...
export default function TopRightMenu() {
    ...
    return (
        <>
            <button className="hidden lg:flex w-[130px] h-[50px] bg-[#0D1829] mt-[20px] rounded-l-full bg-opacity-90 items-center duration-300 hover:bg-[#192E4F] hover:bg-opacity-95 hover:scale-110"
                onClick={() => {
                    popupRef.current?.openPopup()
                }}>
                <h2 className="text-white text-[14px] md:text-[20px] w-full text-center">ผู้จัดทำ</h2>
            </button>
            <PopupDialog header={"ผู้จัดทำ"} ref={popupRef} onClose={() => { }}>
                <div className="w-full">
                    <div className="text-center text-[14px] md:text-[20px] !text-white">
                        ...
                        <div className="grid grid-cols-2 gap-1">
                            ...
                            <p className="text-start flex gap-2">
                                ...
                                <Link legacyBehavior href="https://www.youtube.com/@Rolizami">
                                    <a
                                        target="_blank"
                                        className="flex items-center w-fit gap-2 px-2 py-1 rounded hover:bg-[#2D548F] hover:bg-opacity-90"
                                    >
		...
		c0-3.774,3.982-6.22,7.348-4.514l126.06,63.881C304.363,229.873,304.298,235.248,300.506,237.056z"/>
                            ...
                            <p className="text-start flex gap-2">
                                ...
                                <span className="px-2 rounded cursor-default ">MR.T</span>
                            ...
                            <p className="text-start flex gap-2">
                                ...
                                <span className="px-2 rounded cursor-default ">EX:SELRENS</span>
		...
		c0-3.774,3.982-6.22,7.348-4.514l126.06,63.881C304.363,229.873,304.298,235.248,300.506,237.056z"/>
                            ...
                            <p className="text-start flex gap-2">
                                :
                                <span className="px-2 rounded cursor-default ">Methapon2001</span>
                            </p>

                        </div>
                        <br></br>
                        <div className="md:flex my-1 items-center">
                                ...
                                <p className="flex gap-2 items-center">
                                    <Link legacyBehavior href="https://dev.al-guide-th.com">
                                        <a
                                            ...
                                            className="flex items-center w-fit gap-2 px-2 py-1 rounded hover:bg-[#2D548F] hover:bg-opacity-90"
                                        >
                                            <svg className="w-[40px]" viewBox="0 -198 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                        ...
                        <div className="mx-auto w-[80%] md:flex gap-3 justify-center">
                            <button className="flex items-center w-fit gap-2 px-2 py-1 rounded hover:bg-[#2D548F] hover:bg-opacity-90"
                                ...
                                <LuFolderSync color="#ffffff" size={20} /> Sync ข้อมูลเรือ
                            </button>
                            <button className="flex items-center w-fit gap-2 px-2 py-1 rounded hover:bg-[#2D548F] hover:bg-opacity-90"
                                onClick={() => {
                                    openConfirmDialog({
                            ...
                            <button className="flex items-center w-fit gap-2 px-2 py-1 rounded hover:bg-[#2D548F] hover:bg-opacity-90"
                                onClick={() => {
                                    openConfirmDialog({
                                        title: "Sync ข้อมูลระบบ Research",
                                ...
                                <LuFolderSync color="#ffffff" size={20} /> Sync ข้อมูลระบบ Research
                            </button>
                        </div>
                        <br></br>
                    </div>
