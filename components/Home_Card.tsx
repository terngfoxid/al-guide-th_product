export default function Home_Card() {
    ...
    const card_style = (
        {
            title_style: 'text-zinc-700 dark:text-zinc-200 text-2xl md:text-2xl lg:text-4xl font-bold text-center',
            ...
            body_style: "py-2 text-zinc-600 dark:text-zinc-300 text-xs md:text-sm lg:text-xl xl:text-2xl 2xl:text-3xl text-center",
        }
    );
                            ...
                            <div className="w-11/12 md:w-11/12">
                                <div className="md:grid md:grid-cols-3">
                                    <div className="md:col-span-2 space-y-1">
                                        ...
                                        <p className="py-1 ">นอกจากนี้ยังมีทั้งคลิปรีวิวเรือต่างๆ และประวัติของเรือบางลำ</p>
