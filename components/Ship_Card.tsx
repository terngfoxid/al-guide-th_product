...
export default function Ship_Card(ship: any) {
  ...
  if (shipdata.data.name == null && shipdata.data.error == null) {
    ...
    const card_style = {
      ...
      mrt_shape:
        "hover:scale-110 overflow-hidden group relative w-11/12 rounded-lg shadow-md border bg-neutral-200 hover:bg-neutral-300 border-gray-300 dark:border-gray-800 dark:bg-neutral-800 dark:hover:bg-neutral-700 border-b-4 border-t-1 border-l-1 border-r-1 duration-300",
            ...
            <div id="shipdata2">
              ...
              <div className={card_style.position}>
                <div className={card_style.shape + " relative"}>
                  ...
                  <br></br>
                  <div className="absolute right-0 z-0 w-1/6 h-10 top-2 md:w-max">
