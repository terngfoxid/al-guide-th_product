export default function Loading() {
  const loading_style = {
    symbol_style:
      "w-full text-zinc-600 dark:text-zinc-300 text-2xl font-bold font-serif text-left",
    card_style:
      "block w-max md:w-max p-2 rounded shadow-md border dark:border-gray-800 dark:bg-neutral-700 bg-neutral-200 border-gray-300",
