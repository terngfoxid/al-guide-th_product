...
export default function MetaShowdownPage() {
    ...
    const card_style = {
        shape:
            "hover:scale-110 hover:z-10 overflow-hidden group relative w-full rounded-lg shadow-md border bg-neutral-200 hover:bg-neutral-300 border-gray-300 dark:border-gray-800 dark:bg-neutral-800 dark:hover:bg-neutral-700 border-b-2 border-t-1 border-l-1 border-r-1 duration-300",
        body_style:
