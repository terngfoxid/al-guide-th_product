  ...
  return (
    <>
      <NextSeo
        ...
        description="เว็บไซต์นี้จัดทำขึ้นเพื่อสนับสนุนผู้การเกม AzurLane ชาวไทย โดยจะประกอบไปด้วยการแปลเนื้อหาสกิลของสาวเรือภายในเกม คำแนะนำ และไกด์ในเรื่องต่างๆอย่าง เช่น เรื่องเกียร์สวมใส่แนะนำ นอกจากนี้ยังมีทั้งคลิปรีวิวเรือต่างๆ และประวัติของเรือบางลำเรียบเรียงมาให้ได้อ่านกันด้วยน๊าา \^-^/"
        openGraph={{
          url: 'al-guide-th.com',
          title: 'Azur Lane Guide TH',
          description:"เว็บไซต์นี้จัดทำขึ้นเพื่อสนับสนุนผู้การเกม AzurLane ชาวไทย โดยจะประกอบไปด้วยการแปลเนื้อหาสกิลของสาวเรือภายในเกม คำแนะนำ และไกด์ในเรื่องต่างๆอย่าง เช่น เรื่องเกียร์สวมใส่แนะนำ นอกจากนี้ยังมีทั้งคลิปรีวิวเรือต่างๆ และประวัติของเรือบางลำเรียบเรียงมาให้ได้อ่านกันด้วยน๊าา \^-^/"
