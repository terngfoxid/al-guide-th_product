...
export default function FourOhFour() {
  ...
  return (
    <>
      ...
      <div className={`duration-500 animate-slide-in-bottom bg-[#0D1829] bg-opacity-90 mx-auto w-[90vw] lg:max-w-[calc(100vw-30px)] lg:w-[calc(100vw-30px)] lg:mx-[15px] h-[100%] overflow-y-scroll rounded-2xl p-[5px] md:p-[10px] lg:p-[15px]`}>
